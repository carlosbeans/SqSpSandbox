...
| Modal                | Modals are dialogs presented above an overlay                                                                                                             | [modal.md](components/modal.md)                               | Elements     | No            |
...
| TextField            | TextField allow users to enter and edit text. The component also accepts all HTML input props through an inputProps object                                | [textfield.md](components/textfield.md)                       | Elements     | No            |
...
| ChipInput            | An input that displays user entered text as a highlighted chip. Like Cell, the component can be customized with icons                                     | [chipinput.md](components/chipinput.md)                       | Compositions | No            |
...
| Wizard               | Component that pushes and pops panels for step-based workflows and tutorials                                                                              | [wizard.md](components/wizard.md)                             | Compositions | No            |
...
Themes let you switch the look of your app while being aligned with Squarespace branding. This is because every Rosetta Theme provides a _subset_ of [Rosetta Tokens](https://design-platform.squarespace.net/docs/develop/style-packages/tokens#usage) for a certain visual style; for example, "Light" or "Dark".
